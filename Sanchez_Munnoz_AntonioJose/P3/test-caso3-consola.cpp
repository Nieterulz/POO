/** $Id: test-caso3-consola.cpp 325 2016-04-20 12:56:56Z gerardo $
 * Pruebas del caso 3 de la SGL
 *
 * LIBRERÍA
 * ©2009-2016 Inma, Juanma, Fidel, Gerardo
 */
...
int main()
{
 ...
 Tarjeta
    ...
    jcb(Tipo::VISA, Numero("3530111333300000"), vane, Fecha("31/7/0") + 2*365),
